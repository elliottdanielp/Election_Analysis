...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_list:
        ...
        county_results = (f"{county}: {county_percentage:.1f}% ({county_vote_count:,})\n")
        ...
        if (county_vote_count > largest_county_turnout_count) and (county_percentage > largest_county_percentage):
        
            largest_county_turnout_count = county_vote_count
